...
iotChainTemp.addBlock(iotChainTemp.createGenesisBlock());
iotChainLDR.addBlock(iotChainLDR.createGenesisBlock());
iotChainLED1.addBlock(iotChainLED1.createGenesisBlock());
iotChainLED2.addBlock(iotChainLED2.createGenesisBlock());
// Connect MQTT
